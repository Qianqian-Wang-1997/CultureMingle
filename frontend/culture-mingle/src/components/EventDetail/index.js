            ...
            <Sider style={siderStyle} width={'30%'}>
                ...
                <Footer style={footerStyle}>
                    <div className='buttons'>
                        <Button className='sharebutton' type="primary" icon={<ShareAltOutlined />} size={'large'}>
                            Share
                        </Button>
                        <Button className='joinbutton' type="primary" icon={<UsergroupAddOutlined />} size={'large'}>
                            Join
                        </Button>
                    </div>
                </Footer>
